...
#if defined(USE_ARDUINO) && !defined(USE_RP2040) && !defined(USE_ESP32_VARIANT_ESP32C2)
void MD5Digest::init() {
...
#endif  // USE_ARDUINO && !USE_RP2040 && !USE_ESP32_VARIANT_ESP32C2
...
#endif  // USE_ESP_IDF || USE_ESP32_VARIANT_ESP32C2
